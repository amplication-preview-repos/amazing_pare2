...
@InputType()
class InventoryCreateNestedManyWithoutMedicationsInput {
...
export { InventoryCreateNestedManyWithoutMedicationsInput as InventoryCreateNestedManyWithoutMedicationsInput };
